...
input_file = "E:/Language Model Project/final-model/result/expanded 10 times/20epochs/test_result.csv"
output_file = "E:/Language Model Project/final-model/result/expanded 10 times/20epochs/test_accuracy.csv"
...
pad_token_id = 2  #  token index of pad 
...
'''
type1_erro = df['type1_input_error'].sum()
type2_erro = df['type2_output_share_error'].sum()
type3_erro = df['type3_ood_error'].sum()
